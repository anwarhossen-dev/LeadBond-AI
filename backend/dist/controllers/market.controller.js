...
exports.getWeeklyReport = exports.askBusinessAdvisor = exports.getGrowthPrediction = exports.getCountryMarket = exports.getBusinessOpportunities = exports.getIndustryDetail = exports.getIndustryReports = void 0;
...
// ─── Industry Reports ──────────────────────────────────────────────────────
const getIndustryReports = async (_req, res) => {
    try {
        res.json(INDUSTRIES);
    }
    catch (err) {
...
const getIndustryDetail = async (req, res) => {
    try {
...
exports.getIndustryDetail = getIndustryDetail;
// ─── Business Opportunity Finder ───────────────────────────────────────────
const getBusinessOpportunities = async (req, res) => {
    try {
...
exports.getBusinessOpportunities = getBusinessOpportunities;
// ─── Country Market Analysis ───────────────────────────────────────────────
const getCountryMarket = async (req, res) => {
    try {
        const countries = [
...
exports.getCountryMarket = getCountryMarket;
// ─── Growth Prediction ─────────────────────────────────────────────────────
const getGrowthPrediction = async (req, res) => {
    try {
        const { industry } = req.query;
        const ind = INDUSTRIES.find(i => i.name.toLowerCase().includes((industry || '').toLowerCase())) || INDUSTRIES[0];
        res.json({
            industry: ind.name,
...
// ─── AI Business Advisor ───────────────────────────────────────────────────
const askBusinessAdvisor = async (req, res) => {
    try {
...
exports.askBusinessAdvisor = askBusinessAdvisor;
