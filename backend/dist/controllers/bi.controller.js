...
exports.getFullBiReport = exports.getAiRecommendations = exports.getRiskAnalysis = exports.getSalesOpportunity = exports.getMarketingIntelligence = exports.getWebsiteAnalysis = exports.getTechnologyAnalysis = exports.getHiringIntelligence = exports.getFinancialIntelligence = exports.getSwotAnalysis = exports.getIcpMatch = exports.getLeadScoring = exports.getCustomerAnalysis = exports.getCompetitorAnalysis = exports.getMarketTrends = exports.getGrowthReport = exports.getSalesIntelligence = exports.getProductIntelligence = exports.getBusinessProfile = void 0;
...
exports.getProductIntelligence = getProductIntelligence;
// ─── 3. Sales Intelligence ──────────────────────────────────────────────────
const getSalesIntelligence = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({ where: { id } });
        if (!company)
...
exports.getSalesIntelligence = getSalesIntelligence;
...
exports.getGrowthReport = getGrowthReport;
...
exports.getCompetitorAnalysis = getCompetitorAnalysis;
// ─── 7. Customer Analysis ────────────────────────────────────────────────────
...
exports.getCustomerAnalysis = getCustomerAnalysis;
// ─── 8. Lead Scoring ────────────────────────────────────────────────────────
...
exports.getLeadScoring = getLeadScoring;
// ─── 9. ICP Matching ────────────────────────────────────────────────────────
const getIcpMatch = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({ where: { id } });
        if (!company)
...
exports.getIcpMatch = getIcpMatch;
// ─── 10. SWOT Analysis ──────────────────────────────────────────────────────
...
exports.getSwotAnalysis = getSwotAnalysis;
// ─── 11. Financial Intelligence ─────────────────────────────────────────────
const getFinancialIntelligence = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({ where: { id } });
        if (!company)
...
exports.getFinancialIntelligence = getFinancialIntelligence;
// ─── 12. Hiring Intelligence ────────────────────────────────────────────────
const getHiringIntelligence = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({
            where: { id },
...
exports.getHiringIntelligence = getHiringIntelligence;
// ─── 13. Technology Analysis ────────────────────────────────────────────────
const getTechnologyAnalysis = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({ where: { id } });
        if (!company)
        ...
        const pick = (arr, count) => arr.sort(() => 0.5 - Math.random()).slice(0, count);
        res.json({
...
exports.getTechnologyAnalysis = getTechnologyAnalysis;
// ─── 14. Website Analysis ───────────────────────────────────────────────────
const getWebsiteAnalysis = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({ where: { id } });
        if (!company)
...
exports.getWebsiteAnalysis = getWebsiteAnalysis;
// ─── 15. Marketing Intelligence ─────────────────────────────────────────────
const getMarketingIntelligence = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({ where: { id } });
        if (!company)
...
exports.getMarketingIntelligence = getMarketingIntelligence;
// ─── 16. Sales Opportunity ──────────────────────────────────────────────────
const getSalesOpportunity = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({ where: { id } });
        if (!company)
...
exports.getSalesOpportunity = getSalesOpportunity;
// ─── 17. Risk Analysis ──────────────────────────────────────────────────────
...
const getFullBiReport = async (req, res) => {
    try {
        const { id } = req.params;
        const company = await prisma_1.default.company.findUnique({
            where: { id },
...
exports.getFullBiReport = getFullBiReport;
